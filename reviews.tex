...
%% Sum of reviews
%% Papers
\newcommand{\SumPaper}{\the\numexpr \ejor + \ins + \exsy + \iei + \itor + \orij + \ijpeds + \flex + \ejie + \cin + \scj + \cmplx + \fcs + \spj + \jea + \cim + \mine + \acisc + \ijss + \jifs + \ijlsm + \proc + \aor + \tetci + \plos + \js + \mathj + \kbs + \caor + \eaai + \ener + \asc + \swec + \ijdrr \relax}
%% Conferences
...
\newcommand{\journals}[1]{\FLEX{} (\flex), \INS{} (\ins), \EJOR{} (\ejor), \IJSS{} (\ijss), \TETCI{} (\tetci), \EXSY{} (\exsy), \EAAI{} (\eaai), \PROC{} (\proc), \MATHJ{} (\mathj), \PLOS{} (\plos), \CIM{} (\cim), \CIN{} (\cin), \MINE{} (\mine), \FCS{} (\fcs), \ACISC{} (\acisc), \SPJ{} (\spj), \AOR{} (\aor), \JEA{} (\jea), \ITOR{} (\itor), \ASC{} (\asc), \IJPEDS{} (\ejie), \CAOR{} (\caor), \EJIE{} (\ejie), \ORIJ{} (\orij), \CMPLX{} (\cmplx), \IEI{} (\iei), \IJPEDS{} (\ijpeds), \IJLSM{} (\ijlsm), \JS{} (\js), \KBS{} (\kbs), \ENER{} (\ener), \SWEC{} (\swec), \IJDRR{} (\ijdrr), {#1} \SC{} (\scj).}
