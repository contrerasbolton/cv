...
%% Sum of reviews
\newcommand{\Suma}{\the\numexpr \ejor + \ins + \exsy + \iei + \itor + \orij + \ijpeds + \flex + \ejie + \cin + \scj + \cmplx + \fcs + \spj + \jea + \cim + \mine + \acisc + \ijss + \jifs + \ijlsm + \proc + \aor + \tetci + \plos \relax}
...
\newcommand{\journals}[1]{\FLEX{} (\flex), \EJOR{} (\ejor), \INS{} (\ins), \EXSY{} (\exsy), \PROC{} (\proc), \CIN{} (\cin), \MINE{} (\mine), \FCS{} (\fcs), \ACISC{} (\acisc), \SPJ{} (\spj), \AOR{} (\aor), \IJPEDS{} (\ejie), \EJIE{} (\ejie), \JEA{} (\jea), \IJSS{} (\jifs), \ORIJ{} (\orij), \CMPLX{} (\cmplx), \ITOR{} (\itor), \CIM{} (\cim), \IEI{} (\iei), \IJPEDS{} (\ijpeds), \IJLSM{} (\ijlsm), \TETCI{} (\tetci), \PLOS{} (\plos), {#1} \SC{} (\scj).}
