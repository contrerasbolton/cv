...
\ifthenelse{\equal{\detokenize{tesis_es}}{\jobname}}{
  \toggletrue{es}
...
\es{
  \newcites{Pregrado,Master,Doctorado}{{Memorias de título},{Tesis de magíster},{Tesis de doctorado}}
}
{
  \newcites{Pregrado,Master,Doctorado}{{Final undergraduate projects},{M.Sc. theses},{Ph.D. theses}}
}
\es{
%% \section{Publicaciones}
\firstname{}
\familyname{Supervisión de tesis$\qquad$}
}
{
\firstname{}
\familyname{Supervised theses$\qquad$}
}
% ----------------------------------------------------------------------------------
% content
% ----------------------------------------------------------------------------------
...
\nocitePregrado{*}
\es{\bibliographystylePregrado{spanish}}{\bibliographystylePregrado{english}}
\bibliographyPregrado{supervisorPregrado}

\nociteMaster{*}
\es{\bibliographystyleMaster{spanish}}{\bibliographystyleMaster{english}}
\bibliographyMaster{supervisorMaster}

\nociteDoctorado{*}
%% \es{\bibliographystyleDoctorado{spanish}}{\bibliographystyleDoctorado{english}}
%% \bibliographyDoctorado{supervisorDoctorado}
}
